...
const FormComprar = ({ onClose, data }) => {
  const form = useRef();
  ...
  return (
    <form
      ref={form}
      className="w-80 bg-white p-5 rounded-sm shadow space-y-4 text-black relative"
      onSubmit={(e) => hadlerMensaje(e)}
    >
